...
c--- write output scratch mdat.reloc:
      ...
      write(iunit,'(i9,1x,f11.7,1x,f12.7,1x,f10.5,1x,f10.1,1x,f10.1,
     & 1x,f10.1,
     & 1x,f8.1,1x,f8.1,1x,f8.1,1x,i4,1x,i2,1x,i2,1x,i2,1x,i2,1x,f11.8,
     & 1x,f4.1,1x,i3)')
...
c--- output final locations (mdat.reloc):
      write(fu1,'(i9,1x,f11.7,1x,f12.7,1x,f10.5,1x,f10.1,1x,f10.1,
     & 1x,f10.1,
     & 1x,f8.1,1x,f8.1,1x,f8.1,1x,i4,1x,i2,1x,i2,1x,i2,1x,i2,1x,f11.8,
     & 1x,f4.1,1x,i5,1x,i5,1x,i5,1x,i5,1x,f11.8,1x,f11.8,1x,i3)')
cfw     & 1x,f3.1,1x,i5,1x,i5,1x,i5,1x,i5,1x,f11.8,1x,f11.8,1x,i3)') !neg mag
     & (src_cusp(i),src_lat(i),src_lon(i),src_dep(i),src_x(i),src_y(i),
     & src_z(i),src_ex(i),src_ey(i),src_ez(i),int(ev_date(i)/10000),
     & int(mod(ev_date(i),10000)/100),mod(ev_date(i),100),
     & int(ev_time(i)/1000000),int(mod(ev_time(i),1000000)/10000),
